export const Nav = () => {
  return (
    <div className="flex max-h-14 w-full flex-row items-center justify-between bg-gray-900 px-0 py-0">
      ...
      <div className="flex flex-1 flex-row items-center justify-end">
        <div className="flex flex-1 flex-row items-center justify-end mr-8">
        ...
        <div className="bg-blue-700 py-4 px-10">
          <a
            href="#"
            className="px-4 py-5 text-gray-700 hover:bg-blue-900 hover:text-white"
          >
            Man
          </a>
          <a
